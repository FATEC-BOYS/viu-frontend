 ...
 * o funil anda?".
 *
 * Virou componente porque é servido em dois lugares: `/admin`, onde sempre
 * esteve, e o `/dashboard` de quem é ADMIN. Lá o painel do designer era
 * entregue a ele por falta de ramificação — e, como o escopo de admin não
 * restringe nada no backend, a tela mostrava a plataforma inteira com as
 * palavras erradas: "3 feedbacks esperando você" sobre comentários que
 * esperavam outra pessoa, "seus projetos" sobre projetos alheios, e uma
 * trilha de primeiros passos já concluída pelo trabalho dos outros.
 *
 * O admin coordena a plataforma; a visão dele é macro. É esta.
 *
 * A barreira de papel de `/admin` continua no `admin/layout.tsx`, e quem
 * protege de verdade segue sendo o `requireRole('ADMIN')` do backend.
 */
...
export default function PainelDoAdmin() {
